...
void gen_gpu() {
    ...
    const std::string src_name = "video/";
    ...
    for (int i = 0; i < 4; i++) {
        ...
        std::string A_start_path[5] = { src_name + index[i] + ".png",
                              "edge/edge" + index[i] + ".jpg",
                              "pos/pos" + index[i] + ".jpg",
                              "keyframe/" + index[i] + ".png",
                              "mask/mask0.jpg" };

        cv::Mat A_prime = imread("keyframe/" + index[i] + ".png");
    ...
    for (int i = 1; i < key_cnt; i++) {
        ...
        cv::imwrite("output/B_prime" + std::to_string(i) + ".jpeg", B_prime_pyramids[0]);
